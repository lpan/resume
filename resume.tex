...
\section*{Summary}{}
\newsummary{languages}{Golang, Python, JavaScript, C/C++, Ruby, Clojure}
\quarterspace
\newsummary{interests}{Cloud-native infrastructure, Distributed systems, Database design}
\quarterspace
...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
  \item Built Spinnaker pipelines to allow phased rollout for istio
    gateway-wide configuration changes
  \item Currently building tools and services that work with Kubernetes and
    Spinnaker, to enable scaling at PlanGrid
\end{itemize}
