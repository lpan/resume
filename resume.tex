...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
  \item Took ownership of a critical service written in Golang by ensuring its resiliency and
    availability.
  \item Migrated the service's inter-process communication layer (40k QPS) to gRPC.
  \item Proposed and implemented RPC deadline and cancellation to prevent cascading failures.
\end{itemize}
