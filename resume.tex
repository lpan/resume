...
\quarterspace
\newsummary{interests}{Distributed systems, Streaming architecture, Cloud-native infrastructure}
\quarterspace
...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  ...
  \item Worked on the metrics submission pipeline that streams \textbf{millions} of data
    points per second
  \item Owned the time-series storage service written in Golang by ensuring its
    availability
