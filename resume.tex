...
\section*{Summary}{}
\newsummary{languages}{Golang, Python, JavaScript, C/C++, Ruby}
\quarterspace
\newsummary{interests}{Distributed systems, Database design, Real-time data pipelines}
\quarterspace
\newsummary{technologies}{Kubernetes, Spinnaker, Istio, Envoy, gRPC, Redis, Postgres, Consul}
...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
  \item Worked on one of the infra teams that owns the tooling around PlanGrid's
    deployment systems, as well as the network service mesh
