...
{\fontsize{30}{40}\selectfont \hfill Lawrence Pan \par}
\halfspace
...
\quarterspace
\newsummary{interests}{Distributed systems, Stream processing, Cloud-native infrastructure}
\quarterspace
...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  ...
  \item Owned the time-series creation service written in Golang by ensuring it
    met its SLOs
  \item Migrated the service's IPC layer to gRPC. Implemented consistent hashing
    and request termination, details in
