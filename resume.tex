...
\newsummary{interests}{Distributed systems, Large-scale data processing/storage
  systems, Algorithms}
\smolboispace
...
\section*{Experience}{}
\normalsize
\noindent \href{https://twitter.com.com}{\textbf{\ul{Twitter}}}
$\vert$ \small Software Engineering Intern
{\hfill \footnotesize \textit{May 2019 - Present}}
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
  \item Designed and implemented a system (in Scala) on top of Hive Metastore
    that made Presto and Hive at Twitter GDPR-compliant.
  \item Adding two-phase commit support to Apache Heron (Twitter's stream
    processing engine), to enable end-to-end exactly-once delivery semantic. (in
    progress)
\end{itemize}
