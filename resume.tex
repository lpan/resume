...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
  \item Extended \href{https://apache.github.io/incubator-heron/}{\ul{Apache
        Heron}}'s exactly-once processing semantics to take side effects into
    account, by implementing a variant of the two-phase commit algorithm.
