...
\pagestyle{empty}
\geometry{left=1.2cm, top=1.4cm, right=1.2cm, bottom=1.2cm, footskip=.5cm}
...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
  \item Building tools/applications with Kubernetes, Spinnaker, Salt, Python,
    and Golang to enable scaling at PlanGrid
\end{itemize}
