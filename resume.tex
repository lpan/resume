...
\section*{Summary}{}
\newsummary{languages}{Golang, Scala, Ruby, Python, Clojure, C/C++}
\quarterspace
...
{\hfill \footnotesize \textit{Sep 2018 - present (ongoing)}}
...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  ...
  \item How gRPC helps reliability and fault tolerance at DataDog: \http{lpan.io/migrating-to-grpc/}
\end{itemize}
